...
Sender and Recipient Address Balancy & History

![alt=""](Images/ganache_account_balances.png)

Screenshot from Ganache of the transaction details

![alt=""](Images/ganache_transaction_details.png)

Streamlit Sidebar

![alt=""](Images/streamlit_sidebar.png)

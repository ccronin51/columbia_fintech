...
# Comment: This is local address of Ganache
...
# Comment: MNEMONIC identifies Ganache space
# Comment: Calls generate_account from crypto_wallet.py
...
# YOUR CODE HERE
# Comment: Calls get_balance from crypto_wallet.py with address as param
web3 = Web3(Web3.HTTPProvider('http://127.0.0.1:7545'))
balance = st.sidebar.text(get_balance(web3, account.address))
# private_key=st.sidebar.text(private.hex())
# public_key=st.sidebar.text(public.hex())

...
if st.button('Submit'):
    ...
    for r in returns:
        ...
        constraints = (
        {'type': 'eq', 'fun': checksumtoone}, {'type': 'eq', 'fun': lambda random_weight: getreturn(random_weight) - r})
    ...
    st.write(
        f"As per analysis using varies methods the best return is got from using : {max_return}. Below is the recomended distribution to get the best return:")
